...
def test_inspect_ok():
    with patch("app.routers.products.get_store", return_value=_make_store_ds()):
...
def test_inspect_missing_store():
    with patch(
        "app.routers.products.get_store",
...
def test_inspect_multi_variable():
    ...
    with patch("app.routers.products.get_store", return_value=ds):
...
def test_availability_ok():
    with (
        ...
        patch(
            "app.routers.products.get_available_dates",
